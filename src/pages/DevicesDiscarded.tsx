...
const mockDevices = [
    { id: 1, device: "Ratón", model: "Nilox", code: "RAT-001", date: "13/10/25", status: "Baja", location: "Dpt. Informática", comments: "Equipo obsoleto" },
    { id: 2, device: "Monitor", model: "Philips", code: "MON-002", date: "09/10/25", status: "Baja", location: "Dpt. Informática", comments: "Pantalla rota" },
];
